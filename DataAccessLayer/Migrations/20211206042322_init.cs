...
namespace DataAccessLayer.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdmainID = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => x.ID);
                    table.ForeignKey(
                        name: "FK_Product_AspNetUsers_AdmainID",
                        column: x => x.AdmainID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatrItem", x => x.ID);
                    table.ForeignKey(
                        name: "FK_CatrItem_AspNetUsers_CustomerID",
                        column: x => x.CustomerID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatrItem_Cart_CartID",
                        column: x => x.CartID,
                        principalTable: "Cart",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CatrItem_Product_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatrItem_CartID",
                table: "CatrItem",
                column: "CartID");

            migrationBuilder.CreateIndex(
                name: "IX_CatrItem_CustomerID",
                table: "CatrItem",
                column: "CustomerID");

            migrationBuilder.CreateIndex(
                name: "IX_CatrItem_ProductID",
                table: "CatrItem",
                column: "ProductID");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(
                name: "AspNetUserRoles");
            migrationBuilder.Sql("delete from AspNetUserRoles ", false);

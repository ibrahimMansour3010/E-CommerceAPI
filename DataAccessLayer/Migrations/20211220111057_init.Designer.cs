...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ProductCategory.CategoryEntity", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Models.ProductImage.ProductImageEntity", b =>
                {
                    b.Property<string>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Models.Customer.ApplicationUserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Models.Product.ProductEntity", b =>
                {
                    b.HasOne("Models.Customer.ApplicationUserEntity", "ApplicationUser")
                        .WithMany("Products")
                        .HasForeignKey("AdmainID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Models.ProductCategory.CategoryEntity", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Models.ProductCategory.CategoryEntity", b =>
                {
                    b.HasOne("Models.Department.DepartmentEntity", "Department")
